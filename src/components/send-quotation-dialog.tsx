...
<tr><td style="background:#fff;padding:0 28px 28px" class="pad-lg">
  <div style="background:#F8FAFC;border:1px solid #E2E8F0;border-radius:12px;padding:20px">
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="width:100%;table-layout:fixed">
      <tr>
        <td width="25%" align="center" style="width:25%;text-align:center;padding:18px 12px;vertical-align:middle"><img src="https://www.easemyoffice.in/logos/verizon.png" alt="Verizon" height="28" style="display:inline-block;height:28px;max-height:28px;max-width:78%;width:auto;vertical-align:middle;opacity:0.9"></td>
        <td width="25%" align="center" style="width:25%;text-align:center;padding:18px 12px;vertical-align:middle"><img src="https://easemyoffice.emo-crm.workers.dev/Homelane.png" alt="HomeLane" height="28" style="display:inline-block;height:28px;max-height:28px;max-width:78%;width:auto;vertical-align:middle;opacity:0.9"></td>
        <td width="25%" align="center" style="width:25%;text-align:center;padding:18px 12px;vertical-align:middle"><img src="https://www.easemyoffice.in/logos/omnicuris.png" alt="Omnicuris" height="28" style="display:inline-block;height:28px;max-height:28px;max-width:78%;width:auto;vertical-align:middle;opacity:0.9"></td>
        <td width="25%" align="center" style="width:25%;text-align:center;padding:18px 12px;vertical-align:middle"><img src="https://easemyoffice.emo-crm.workers.dev/Fitelo.png" alt="Fitelo" height="28" style="display:inline-block;height:28px;max-height:28px;max-width:78%;width:auto;vertical-align:middle;opacity:0.9"></td>
      </tr>
      <tr>
        <td width="25%" align="center" style="width:25%;text-align:center;padding:18px 12px;vertical-align:middle"><img src="https://www.easemyoffice.in/logos/kineticgreen.png" alt="Kinetic Green" height="28" style="display:inline-block;height:28px;max-height:28px;max-width:78%;width:auto;vertical-align:middle;opacity:0.9"></td>
        <td width="25%" align="center" style="width:25%;text-align:center;padding:18px 12px;vertical-align:middle"><img src="https://easemyoffice.emo-crm.workers.dev/earthtron.png" alt="EarthtronEV" height="28" style="display:inline-block;height:28px;max-height:28px;max-width:78%;width:auto;vertical-align:middle;opacity:0.9"></td>
        <td width="25%" align="center" style="width:25%;text-align:center;padding:18px 12px;vertical-align:middle"><img src="https://www.easemyoffice.in/logos/udaan.png" alt="Udaan" height="28" style="display:inline-block;height:28px;max-height:28px;max-width:78%;width:auto;vertical-align:middle;opacity:0.9"></td>
        <td width="25%" align="center" style="width:25%;text-align:center;padding:18px 12px;vertical-align:middle"><img src="https://www.easemyoffice.in/logos/thirdwavecoffee.png" alt="Third Wave Coffee" height="28" style="display:inline-block;height:28px;max-height:28px;max-width:78%;width:auto;vertical-align:middle;opacity:0.9"></td>
      </tr>
    </table>
    ...
    <tr>
      ...
      <td class="stack" style="width:50%;padding:6px;vertical-align:top">
        <div style="background:#F8FAFC;border:1px solid #E2E8F0;border-radius:10px;padding:16px;text-align:center">
          ...
          <div style="margin-top:10px"><span style="display:inline-block;background:#1E4DB7;color:#fff;font-size:10px;font-weight:700;padding:5px 12px;border-radius:6px">&#8377;599/Day</span></div>
        </div>
      </td>
    </tr>
    <tr>
...
export function SendQuotationDialog({
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      toast.error(getErrorMessage(e, "Could not send quotation"));
    } finally {
      setSending(false);
    }
  };

  ...
  <div style="background:#F8FAFC;border:1px solid #E2E8F0;border-radius:12px;padding:20px">
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="width:100%;table-layout:fixed">
      <tr>
        ...
        <td width="25%" align="center" style="width:25%;text-align:center;padding:10px 8px;vertical-align:middle"><img src="https://easemyoffice.emo-crm.workers.dev/Homelane.png" alt="HomeLane" height="22" style="display:inline-block;height:22px;max-height:22px;max-width:90%;width:auto;vertical-align:middle;opacity:0.8"></td>
        ...
        <td width="25%" align="center" style="width:25%;text-align:center;padding:10px 8px;vertical-align:middle"><img src="https://easemyoffice.emo-crm.workers.dev/Fitelo.png" alt="Fitelo" height="22" style="display:inline-block;height:22px;max-height:22px;max-width:90%;width:auto;vertical-align:middle;opacity:0.8"></td>
      </tr>
      <tr>
        ...
        <td width="25%" align="center" style="width:25%;text-align:center;padding:10px 8px;vertical-align:middle"><img src="https://easemyoffice.emo-crm.workers.dev/earthtron.png" alt="EarthtronEV" height="22" style="display:inline-block;height:22px;max-height:22px;max-width:90%;width:auto;vertical-align:middle;opacity:0.8"></td>
